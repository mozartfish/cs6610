...
glm::mat4 mvnMatrix;           // global variable for representing the model view space for normal space
...
void myDisplay()
{
    ...
    // Calculate the Model View Normal Matrix
    mvnMatrix = viewMatrix * modelMatrix;
    mvnMatrix = glm::inverseTranspose(glm::mat3(mvnMatrix));
